(function () {
    ...
    var templates = {
      ...
      activity: html$_,
      settings: html$Y,
      settings_main: html$X,
      settings_interface: html$W,
      settings_parser: html$V,
      settings_server: html$U,
      settings_player: html$T,
      settings_more: html$S,
      scroll: html$Z,
      items_line: html$R,
      card: html$Q,
      full_start: html$P,
      ...
      player_info: html$I,
      selectbox: html$H,
      selectbox_item: html$G,
      info: html$F,
      more: html$D,
      search: html$C,
      settings_input: html$B,
      modal: html$A,
      company: html$z,
      ...
      about: html$q,
      error: html$p,
      torrent_noconnect: html$o,
      styles: html$l,
      torrent_nocheck: html$n,
      torrent_nohash: html$m,
      filter: html$E,
      search_box: html$k,
      console: html$j,
      icon_star: html$i,
    ...
    function toggle$7(where, card) {
      var find = check(card);
      if (find[where]) remove(where, card);else add$4(where, card);
    }
    ...
    function stat$1(url) {
      ...
      stat_timer = setInterval(function () {
        ...
        network$2.silent(url.replace('&preload', '').replace('play', 'stat'), function (data) {
    ...
    function connect() {
      ...
      var ip = Torserver.ip();
      network.silent(Torserver.url() + '/settings', function (json) {
        if (!json.CacheSize) {
    ...
    function show$1(files) {
      ...
      plays.forEach(function (element) {
        var hash = Timeline.hash(element, active.movie || SERVER.object || {}),
