export default {
    ...
    settings_server_preload_descr: 'Așteaptă procesarea buffer-ului de preîncărcare TorrServer înainte de redare',
    ...
    settings_server_search_type_descr: 'Surse pentru căutarea torrentelor: Rutor integrat, indexatoare Torznab din TorrServer sau ambele.',
    ...
    title_upcoming_episodes: 'Următoarele lansări de episoade',
    title_recent_episodes: 'Episoade lansate recent',
    ...
    adult_content_text_modal: 'Acest film sau serial conține conținut pentru adulți. Pentru a continua, trebuie să ai cel puțin 18 ani. Te rugăm să confirmi că ești major.',
    ...
    remote_configuration_registration_text: 'Configurarea de la distanță oferă acces temporar la aplicația dvs., o altă aplicație va putea instala extensii și configura setările.',
    remote_configuration_waite_text: 'Acum puteți transmite acest cod unei alte aplicații pentru a acorda acces la setări.',
    remote_configuration_open_button: 'Permite accesul',
    remote_configuration_code_life: 'Codul este valabil',
    remote_configuration_notice_nocode: 'Nu s-a putut acorda accesul',
    ...
    title_meta_profanity: 'Limbaj vulgar',
    title_meta_sadness: 'Tristețe',
    title_meta_sex: 'Sexualitate',
    player_pip: 'Minimizare',
    player_volume: 'Volum',
    player_time_end: 'Se termină la',
    player_ai_agent_info: 'Vrei să afli mai multe despre videoclip? Întreabă asistentul AI, iar acesta îți va oferi un grafic al stării de spirit, un scurt rezumat și momentele interesante.',
    player_ai_agent_ask_plot: 'Rezumat',
    player_ai_agent_ask_moods: 'Afișează graficul',
    player_ai_agent_ask_highlights: 'Momente interesante',
    player_ai_agent_ask: 'Întreabă',
    player_ai_agent_processing: 'Analizez...',
    player_ai_agent_no_data: 'Nu există date de afișat.',
    player_ai_agent_no_analysis: 'Nu s-a putut analiza videoclipul.',
    player_ai_agent_quota: 'Limita de cereri a fost depășită. Vă rugăm să încercați din nou mai târziu.',
    player_ai_agent_working: 'Lucrez încă la asta...',
    title_meta_humor: 'Umor',
    title_meta_tension: 'Tensiune',
    title_meta_romance: 'Romantism',
    title_meta_pace: 'Ritm',
    title_meta_importance: 'Scene importante',
    title_meta_action: 'Acțiune'
}
