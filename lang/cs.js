export default {
    ...
    player_pip: 'Zmenšit',
    player_volume: 'Hlasitost',
    player_time_end: 'Konec v',
    player_ai_agent_info: 'Chcete se dozvědět více o videu? Zeptejte se AI asistenta a ten vám poskytne graf nálad, krátké shrnutí děje a zajímavé momenty.',
    player_ai_agent_ask_plot: 'Krátce o ději',
    player_ai_agent_ask_moods: 'Zobrazit graf',
    player_ai_agent_ask_highlights: 'Zajímavé momenty',
    player_ai_agent_ask: 'Zeptat se',
    player_ai_agent_processing: 'Analyzuji...',
    player_ai_agent_no_data: 'Žádná data k zobrazení.',
    player_ai_agent_no_analysis: 'Analýza videa se nezdařila.',
    player_ai_agent_quota: 'Limit požadavků byl překročen. Zkuste to prosím znovu později.',
    player_ai_agent_working: 'Stále na tom pracuji...',
    title_meta_humor: 'Humor',
    title_meta_tension: 'Napětí',
    title_meta_romance: 'Romance',
    title_meta_pace: 'Tempo',
    title_meta_importance: 'Klíčové scény',
    title_meta_action: 'Akce'
};
