export default {
    ...
    player_pip: 'Намали',
    player_volume: 'Сила на звука',
    player_time_end: 'Край в',
    player_ai_agent_info: 'Искате ли да научите повече за видеото? Попитайте AI асистента, и той ще ви предостави графика на настроенията, кратко резюме и интересни моменти.',
    player_ai_agent_ask_plot: 'Накратко за сюжета',
    player_ai_agent_ask_moods: 'Покажи графика',
    player_ai_agent_ask_highlights: 'Интересни моменти',
    player_ai_agent_ask: 'Попитай',
    player_ai_agent_processing: 'Анализирам...',
    player_ai_agent_no_data: 'Няма данни за показване.',
    player_ai_agent_no_analysis: 'Не успя да анализира видеото.',
    player_ai_agent_quota: 'Лимитът на заявки е надвишен. Моля, опитайте по-късно.',
    player_ai_agent_working: 'Все още работя върху това...',
    title_meta_humor: 'Хумор',
    title_meta_tension: 'Напрежение',
    title_meta_romance: 'Романтика',
    title_meta_pace: 'Темпо',
    title_meta_importance: 'Ключови сцени',
    title_meta_action: 'Екшън'
}
